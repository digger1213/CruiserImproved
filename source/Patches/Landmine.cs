...
internal class LandminePatches
{
    ...
    static bool ShouldNotDealKnockback(PlayerControllerB instance)
    {
        ...
        return NetworkSync.Config.PreventMissileKnockback && instance.inVehicleAnimation && validCruiser && __instance.currentTriggerInAnimationWith.overridePlayerParent.TryGetComponent<VehicleController>(out var controller) && controller.vehicleID == 0;
    }
